...
import 'package:genui_core/src/ai_client/gemini_schema_adapter.dart';
...
void main() {
  group('SchemaAdapter', () {
    ...
    group('adaptObject', () {
      ...
      test('should copy the description for an object', () {
        final dsbSchema = dsb.S.object(
        ...
        expect(result.errors, isEmpty);
        expect(result.schema, isNotNull);
        expect(result.schema!.description, 'A test object.');
      });

      test('should handle an object with additionalProperties', () {
        final dsbSchema = dsb.S.object(
        ...
        expect(result.schema!.optionalProperties, isNull);
        expect(
    ...
    group('adaptArray', () {
      ...
      test('should copy the description for an array', () {
        final dsbSchema = dsb.S.list(
        ...
        expect(result.errors, isEmpty);
        expect(result.schema, isNotNull);
        expect(result.schema!.description, 'A test array.');
      });
    ...
    group('adaptString', () {
      ...
      test('should copy the description for a string', () {
        final dsbSchema = dsb.S.string(description: 'A test string.');
    ...
    group('adaptNumber', () {
      ...
      test('should copy the description for a number', () {
        final dsbSchema = dsb.S.number(description: 'A test number.');

        final result = adapter.adapt(dsbSchema);

        expect(result.errors, isEmpty);
        expect(result.schema, isNotNull);
        expect(result.schema!.description, 'A test number.');
      });
    ...
    group('adaptInteger', () {
      ...
      test('should copy the description for an integer', () {
        final dsbSchema = dsb.S.integer(description: 'A test integer.');

        final result = adapter.adapt(dsbSchema);

        expect(result.errors, isEmpty);
        expect(result.schema, isNotNull);
        expect(result.schema!.description, 'A test integer.');
      });
    ...
    group('adaptBoolean', () {
      ...
      test('should copy the description for a boolean', () {
        final dsbSchema = dsb.S.boolean(description: 'A test boolean.');

        final result = adapter.adapt(dsbSchema);

        expect(result.errors, isEmpty);
        expect(result.schema, isNotNull);
        expect(result.schema!.description, 'A test boolean.');
      });
    });
    ...
    group('adaptNull', () {
      ...
      test('should copy the description for a null', () {
        final dsbSchema = dsb.S.nil(description: 'A test null.');

        final result = adapter.adapt(dsbSchema);

        expect(result.errors, isEmpty);
        expect(result.schema, isNotNull);
        expect(result.schema!.description, 'A test null.');
      });
    });
    ...
    group('General Error Handling', () {
      ...
      test('should adapt an empty schema to an object schema', () {
    ...
    group('Edge Cases', () {
      ...
      test('should handle "any" schema', () {
        final dsbSchema = dsb.S.any(description: 'Any value.');
        final result = adapter.adapt(dsbSchema);
        expect(result.errors, isEmpty);
        expect(result.schema, isNotNull);
        expect(result.schema!.description, 'Any value.');
        final anyOf = result.schema!.anyOf;
    ...
    group('anyOf', () {
      test('should adapt a schema with anyOf', () {
        final dsbSchema = dsb.S.combined(
          anyOf: [dsb.S.string(), dsb.S.integer(), dsb.S.boolean()],
        );
        ...
        expect(result.errors, isEmpty);
        expect(result.schema, isNotNull);
        expect(result.schema!.anyOf, hasLength(3));
        expect(result.schema!.anyOf![0].type, firebase_ai.SchemaType.string);
        expect(result.schema!.anyOf![1].type, firebase_ai.SchemaType.integer);
        expect(result.schema!.anyOf![2].type, firebase_ai.SchemaType.boolean);
      });
    });
  });
}
